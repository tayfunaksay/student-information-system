...
public class UpdateCourseRequest {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.courseCredit, courseCredit) == 0 && courseAKTS == that.courseAKTS && theoreticalLessonHour == that.theoreticalLessonHour && practicalLessonHour == that.practicalLessonHour && isNeedProjectorAndComputer == that.isNeedProjectorAndComputer && isTherePreCourse == that.isTherePreCourse && Objects.equals(id, that.id) && Objects.equals(originalName, that.originalName) && Objects.equals(turkishName, that.turkishName) && Objects.equals(code, that.code) && courseType == that.courseType && Objects.equals(departmentId, that.departmentId);
    }
