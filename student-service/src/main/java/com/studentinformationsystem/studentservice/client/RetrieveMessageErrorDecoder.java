...
import com.studentinformationsystem.studentservice.exception.DetailNotFoundException;
import com.studentinformationsystem.studentservice.exception.ExceptionMessage;
...
public class RetrieveMessageErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        switch (response.status()){
            case 404:
                throw new DetailNotFoundException(message);
            default:
