...
public class UpdateCourseRequest {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.courseCredit, courseCredit) == 0 && courseAKTS == that.courseAKTS && theoreticalLessonHour == that.theoreticalLessonHour && practicalLessonHour == that.practicalLessonHour && isNeedProjectorAndComputer == that.isNeedProjectorAndComputer && Objects.equals(id, that.id) && Objects.equals(originalName, that.originalName) && Objects.equals(turkishName, that.turkishName) && Objects.equals(code, that.code) && courseType == that.courseType && semesterType == that.semesterType && Objects.equals(departmentId, that.departmentId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, originalName, turkishName, code, courseCredit, courseAKTS, theoreticalLessonHour, practicalLessonHour, courseType, semesterType, departmentId, isNeedProjectorAndComputer);
    }
